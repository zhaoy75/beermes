...
as $$
  select jsonb_build_object(
    ...
    'tax_transformation_rules', jsonb_build_array(
      ...
      jsonb_build_object('movement_intent','SHIP_DOMESTIC','src_site_type','TAX_STORAGE','dst_site_type','DOMESTIC_CUSTOMER','lot_tax_type','TAX_SUSPENDED','allowed_tax_decisions',jsonb_build_array(jsonb_build_object('tax_decision_code','TAXABLE_REMOVAL','tax_event','TAXABLE_REMOVAL','default',true))),
      jsonb_build_object('movement_intent','SHIP_DOMESTIC','src_site_type','TAX_STORAGE','dst_site_type','DOMESTIC_CUSTOMER','lot_tax_type','TAX_PAID','allowed_tax_decisions',jsonb_build_array(jsonb_build_object('tax_decision_code','NONE','tax_event','NONE','default',true))),
