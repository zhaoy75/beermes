...
begin
  ...
  insert into public.mes_batches (
    ...
    nullif(p_doc ->> 'planned_start', '')::date::timestamptz,
    nullif(p_doc ->> 'planned_end', '')::date::timestamptz,
    nullif(p_doc ->> 'actual_start', '')::date::timestamptz,
    nullif(p_doc ->> 'actual_end', '')::date::timestamptz,
    p_doc ->> 'notes',
