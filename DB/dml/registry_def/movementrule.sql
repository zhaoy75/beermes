...
VALUES (
  ...
  "site_type_labels": {
    ...
    "DOMESTIC_CUSTOMER": {
      "ja": "国内の得意先",
      "en": "Domestic Customer"
    },
    "OVERSEA_CUSTOMER": {
      "ja": "海外の得意先/輸出業者",
      "en": "Overseas Customer"
    },
    "OTHER_BREWERY": {
      "ja": "他の酒類製造者の製造場",
      "en": "Other Brewery"
    ...
    "DISPOSAL_FACILITY": {
      "ja": "廃棄施設",
      "en": "Disposal Facility"
    },
    "DIRECT_SALES_SHOP": {
      "ja": "直営販売店",
      "en": "Direct Sales Shop"
    }
  },
  "lot_tax_type_labels": {
    "TAX_SUSPENDED": {
  ...
  "tax_transformation_rules": [
    ...
    {
      "movement_intent": "RETURN_FROM_CUSTOMER",
      "src_site_type": "OVERSEA_CUSTOMER",
      "dst_site_type": "BREWERY_MANUFACTUR",
      "lot_tax_type": "TAX_PAID",
      "allowed_tax_decisions": [
        {
      ...
      "allowed_tax_decisions": [
        {
          "tax_decision_code": "RETURN_TO_FACTORY_NON_TAXABLE",
          "tax_event": "RETURN_TO_FACTORY_NON_TAXABLE",
          "result_lot_tax_type": "TAXTAX_SUSPENDED_PAID",
          "default": true,
          "lines_rules": {
            "allow_partial_quantity": true,
            "require_full_lot": false,
