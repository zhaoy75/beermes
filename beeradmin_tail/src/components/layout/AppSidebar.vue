<template>
  <aside
    :class="[
      'fixed mt-16 flex flex-col lg:mt-0 top-0 px-[5px] left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-99999 border-r border-gray-200',
      {
    ...
    items: [
      ...
      // },
      {
        ...
        subItems: [
          ...
          ...(canSeeDevelopmentFeatures.value ? [{ name: t('sidebar.items.equipmentScheduleBoard'), path: "/equipment-schedule", pro: false, textClass: developmentMenuTextClass }] : []),
