...
begin
  ...
  update public.mes_batches b
     set batch_label = coalesce(p_patch ->> 'batch_label', b.batch_label),
         ...
         actual_start = coalesce(nullif(p_patch ->> 'actual_start','')::date::timestamptz, b.actual_start),
         actual_end = coalesce(nullif(p_patch ->> 'actual_end','')::date::timestamptz, b.actual_end),
